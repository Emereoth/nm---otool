...
/*   Updated: 2019/02/15 17:14:03 by acottier         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	display_archive_list(t_archive *list, t_meta *f, int *rval)
{
	char		*obj_ptr;
	t_archive	*cursor;
	int			namesize;
...
int			static_lib(t_meta *file)
{
	...
	display_archive_list(list, file, &rvalue);
	return (rvalue);
}
